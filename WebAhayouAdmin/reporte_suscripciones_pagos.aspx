<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_suscripciones_pagos.aspx.cs" Inherits="WebAhayouAdmin.reporte_suscripciones_pagos" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- end form-group row -->
										<!-- begin page-header -->
											<h1 class="page-header">Reporte suscripciones pagos<small></small></h1>
													...
													<table id="data-table-buttons" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
														<thead>
															...
															<th class="text-wrap">NOMBRE COMPLETO</th>
																			...
																			<th class="text-nowrap">FECHA INCIO</th>
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_COMPLETO") %>'></asp:Label></td>
																							...
																							<td><asp:Label ID="Label545" runat="server" Text='<%# Eval("FECHA_FIN") %>'></asp:Label></td>
																							<td><asp:Label ID="Label544" runat="server" Text='<%# Eval("PLANES") %>'></asp:Label></td>
															</tr>
															</ItemTemplate>
															</asp:Repeater>
														</tbody>
