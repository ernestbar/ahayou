...
{
    public partial class reporte_consumo_por_contenido : System.Web.UI.Page
    {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            Repeater1.DataSource = Clases.Reportes.PR_REP_GET_CONSUMO_POR_CONTENIDO(DateTime.Parse(fecha_ini), DateTime.Parse(fecha_fin));
            Repeater1.DataBind();
        }
    }
}