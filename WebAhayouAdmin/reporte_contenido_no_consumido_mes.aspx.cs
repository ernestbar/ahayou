...
{
    public partial class reporte_contenido_no_consumido_mes : System.Web.UI.Page
    {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            Repeater1.DataSource = Clases.Reportes.PR_REP_GET_NO_CONSUMIDO_EN_MESES(int.Parse(txtMeses.Text));
            Repeater1.DataBind();
        }
    }
}