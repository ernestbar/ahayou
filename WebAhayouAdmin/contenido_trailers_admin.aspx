<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="contenido_trailers_admin.aspx.cs" Inherits="WebAhayouAdmin.contenido_trailers_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	   ...
	   <asp:ObjectDataSource ID="odsGrilla" runat="server" SelectMethod="PR_STR_GET_CONTENIDO_TRAILER" TypeName="WebAhayouAdmin.Clases.Contenido_trailers">
		   <SelectParameters>
        ...
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
                                                <asp:Button ID="btnNuevo" class="btn btn-success btn-lg col-md-12" BackColor="Transparent" OnClick="btnNuevo_Click" runat="server" Text="Nuevo contenido trailers" />
									...
									<ItemTemplate>
													...
													<td>
																	...
																	<asp:Button ID="btnEditar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("COD_CONTENIDO_PELICULA") %>' OnClick="btnEditar_Click" runat="server" Text="Editar" ToolTip="Editar" />
																	<asp:Button ID="btnEliminar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("COD_CONTENIDO_PELICULA") %>' OnClientClick="return confirm('Estas seguro de eliminar el registro???')" OnClick="btnEliminar_Click" runat="server" Text="Eliminar" ToolTip="Elimina el registro" />
...
<div class="row">
	...
	<div class="col-md-12 offset-md-0">
		...
		<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16">Registro de contenido trailer</legend>
		<!-- BEGIN #accordion -->
				...
				<div class="accordion-item border-0">
					<div class="accordion-header" id="headingOne">
						<button class="accordion-button bg-gray-900 text-white px-3 py-10px pointer-cursor" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
							<i class="fa fa-circle fa-fw text-blue me-2 fs-8px"></i> DATOS TRAILER
						</button>
					</div>
						...
						<div class="accordion-body bg-gray-800 text-white">
							<!-- begin form-group row -->
								...
								<!-- end form-group row -->
											<!-- begin form-group row -->
										<div class="form-group row m-b-10">
														<label class="col-md-13 text-md-right col-form-label">Orden:</label>
														<div class="col-md-1">
															<asp:TextBox ID="txtOrden" TextMode="Number" class="form-control"  runat="server"></asp:TextBox>
															<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtOrden" Font-Bold="True"></asp:RequiredFieldValidator>
														</div>
										</div>
						<!-- end form-group row -->			
								<!-- begin form-group row -->
