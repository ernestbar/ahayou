<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_usuarios_sin_suscripcion.aspx.cs" Inherits="WebAhayouAdmin.reporte_usuarios_sin_suscripcion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	    ...
	    <asp:ObjectDataSource ID="odsReporte" runat="server" SelectMethod="PR_REP_GET_USUARIOS_SIN_SUSCRIPCION" TypeName="WebAhayouAdmin.Clases.Reportes">
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_COMPLETO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label21" runat="server" Text='<%# Eval("EMAIL") %>'></asp:Label></td>
																							<td><asp:Label ID="Label22" runat="server" Text='<%# Eval("CELULAR") %>'></asp:Label></td>
																							<td><asp:Label ID="Label23" runat="server" Text='<%# Eval("FECHA_REGISTRO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label54" runat="server" Text='<%# Eval("ESTADO") %>'></asp:Label></td>
																			<%--<td>
