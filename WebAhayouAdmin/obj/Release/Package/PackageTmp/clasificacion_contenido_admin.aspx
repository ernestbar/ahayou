<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="clasificacion_contenido_admin.aspx.cs" Inherits="WebAhayouAdmin.clasificacion_contenido_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<asp:ObjectDataSource ID="odsFormatoContenido" runat="server" SelectMethod="PR_STR_GET_FORMATO_CONTENIDO" TypeName="WebAhayouAdmin.Clases.Formatos_contenido">
	   ...
	   <asp:ObjectDataSource ID="odsGrilla" runat="server" SelectMethod="PR_STR_GET_CLASIFICACION_CONTENIDO" TypeName="WebAhayouAdmin.Clases.Clasificacion_contenidos">
		   <SelectParameters>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- begin page-header -->
												<!-- begin page-header -->
																<h1 class="page-header">Clasificacion de contenidos admin <small></small></h1>
																Formato contenido:
											...
											<table id="data-table-responsive" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
												<thead>
													<tr>
													<th class="text-wrap">CODIGO CLASIFIACION CONTENIDO</th>
									...
									<ItemTemplate>
													...
													<td><asp:Label ID="lblEsPrincipal1" runat="server" Text='<%# Eval("COD_CLASIFIFICACION_CONTENIDO") %>'></asp:Label></td>
													<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("FORMATO_CONTENIDO") %>'></asp:Label></td>
													<td><asp:Label ID="lblEsPrincipal3" runat="server" Text='<%# Eval("CLASIFICACION") %>'></asp:Label></td>
																	
																	<%--<td><asp:Label ID="Label5" runat="server" Text='<%# Eval("DESC_ESTADO") %>'></asp:Label></td>--%>
													<td>
																	<asp:Button ID="btnEditar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("COD_CLASIFIFICACION_CONTENIDO") %>' OnClick="btnEditar_Click" runat="server" Text="Editar" ToolTip="Editar" />
																	<asp:Button ID="btnEliminar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("COD_CLASIFIFICACION_CONTENIDO") %>' OnClientClick="return confirm('Estas seguro de eliminar el registro???')" OnClick="btnEliminar_Click" runat="server" Text="Eliminar" ToolTip="Elimina el registro" />
