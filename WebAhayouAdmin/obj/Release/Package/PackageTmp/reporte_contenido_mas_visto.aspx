<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_contenido_mas_visto.aspx.cs" Inherits="WebAhayouAdmin.reporte_contenido_mas_visto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	    ...
	    <asp:ObjectDataSource ID="odsReporte" runat="server" SelectMethod="PR_REP_GET_CONTENIDO_MAS_VISTO" TypeName="WebAhayouAdmin.Clases.Reportes">
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- begin page-header -->
											<h1 class="page-header">Reporte contenido mas visto<small></small></h1>
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_CONTENIDO") %>'></asp:Label></td>
																							...
																							<td><asp:Label ID="Label22" runat="server" Text='<%# Eval("VISTA") %>'></asp:Label></td>
																			<%--<td>
