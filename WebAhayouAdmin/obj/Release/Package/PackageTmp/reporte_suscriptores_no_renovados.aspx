<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_suscriptores_no_renovados.aspx.cs" Inherits="WebAhayouAdmin.reporte_suscriptores_no_renovados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	    ...
	    <asp:ObjectDataSource ID="odsReporte" runat="server" SelectMethod="PR_REP_GET_SUSCRIPCIONES_NO_RENOVADAS_MES_PASADO" TypeName="WebAhayouAdmin.Clases.Reportes">
