<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_ingresos_mes.aspx.cs" Inherits="WebAhayouAdmin.reporte_ingresos_mes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	    ...
	    <asp:ObjectDataSource ID="odsReporte" runat="server" SelectMethod="PR_REP_GET_INGRESOS_PAGOS_EN_MES" TypeName="WebAhayouAdmin.Clases.Reportes">
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- begin page-header -->
											<h1 class="page-header">Reporte ingresos mensual<small></small></h1>
													...
													<table id="data-table-buttons" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
														<thead>
															...
															<th class="text-wrap">NOMBRE COMPLETO</th>
																			...
																			<th class="text-nowrap">FECHA_INCIO</th>
																			<th class="text-nowrap">FECHA_FIN</th>
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_COMPLETO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label21" runat="server" Text='<%# Eval("FECHA_PAGO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label22" runat="server" Text='<%# Eval("ESTADO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label23" runat="server" Text='<%# Eval("MONTO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label54" runat="server" Text='<%# Eval("MONEDA") %>'></asp:Label></td>
																							<td><asp:Label ID="Label541" runat="server" Text='<%# Eval("COMENTARIOS") %>'></asp:Label></td>
																							<td><asp:Label ID="Label542" runat="server" Text='<%# Eval("EMAIL") %>'></asp:Label></td>
																							<td><asp:Label ID="Label543" runat="server" Text='<%# Eval("FECHA_INICIO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label544" runat="server" Text='<%# Eval("FECHA_FIN") %>'></asp:Label></td>
																							<td><asp:Label ID="Label545" runat="server" Text='<%# Eval("PLANES") %>'></asp:Label></td>
																			<%--<td>
