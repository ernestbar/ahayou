<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="banner_principal_admin.aspx.cs" Inherits="WebAhayouAdmin.banner_principal_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	   ...
	   <asp:ObjectDataSource ID="odsLista" runat="server" SelectMethod="PR_PAR_GET_BANNER" TypeName="WebAhayouAdmin.Clases.Banners_principales">
	<%--<SelectParameters>
    ...
    background-image: linear-gradient(to bottom right, rgba(0, 0, 0, 0.5), /* Adjust transparency for top side */ transparent);">
			...
			<asp:Label ID="lblCodBanner" runat="server" Text="" Visible="false"></asp:Label>
			<asp:Label ID="lblImagenAnt" runat="server" Text="" Visible="false"></asp:Label>
        ...
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
                                                <asp:Button ID="btnNuevo" class="btn btn-success btn-lg col-md-12" BackColor="Transparent" OnClick="btnNuevo_Click" runat="server" Text="Nuevo Banner Principal" />
										...
										<!-- begin page-header -->
											<h1 class="page-header">Administrador de banner principal <small></small></h1>
							...
							<table id="data-table-responsive" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
								<thead>
									<tr>
									<th class="text-wrap">COD BANNER</th>
													<th class="text-nowrap">DESCRIPCION</th>
													<th class="text-nowrap">DESCRIPCION1</th>
													<th class="text-nowrap">CONTENIDO</th>
													<th class="text-nowrap">DESCRIPCION_INGLES</th>
													<th class="text-nowrap">DESCRIPCION1_INGLES</th>
									<th class="text-nowrap" data-orderable="false">OPCIONES</th>
				
									</tr>
								</thead>
								<tbody>
									<asp:Repeater ID="Repeater1" DataSourceID="odsLista" OnItemDataBound="Repeater1_ItemDataBound" runat="server">
									<ItemTemplate>
													<tr class="gradeA">
													...
													<td>
																	<asp:Button ID="btnEditar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("COD_BANNER") %>' OnClick="btnEditar_Click" runat="server" Text="Editar" ToolTip="Editar" />
																	<asp:Button ID="btnEliminar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("COD_BANNER") %>' OnClick="btnEliminar_Click" runat="server" Text="Activar/Desactivar" ToolTip="Activa o desactiva el registro" />
		 ...
		 <asp:View ID="View2" runat="server">
			...
			<div class="row">
				...
				<div class="col-md-6 offset-md-2">
					...
					<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16">Registro de Banners Principales</legend>
					
					<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						<label class="col-md-3 text-md-right col-form-label">Codigo Banner:</label>
						<div class="col-md-6">
                             <asp:TextBox ID="txtCodBanner" class="form-control" runat="server"></asp:TextBox>
							<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtCodBanner" Font-Bold="True"></asp:RequiredFieldValidator>
						</div>
					</div>
					<!-- end form-group row -->
				<!-- begin form-group row -->
					...
					<div class="form-group row m-b-10">
						...
						<div class="col-md-6">
							 <asp:TextBox ID="txtContenido" TextMode="MultiLine" class="form-control" runat="server"></asp:TextBox>
