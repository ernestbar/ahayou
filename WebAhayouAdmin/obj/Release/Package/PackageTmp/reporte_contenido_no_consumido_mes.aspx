<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_contenido_no_consumido_mes.aspx.cs" Inherits="WebAhayouAdmin.reporte_contenido_no_consumido_mes" %>
        ...
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										<div class="form-group row m-b-10">
											<div class="col-md-6">
											 Nro. de meses:
											<asp:TextBox ID="txtMeses" class="form-control" TextMode="Number" Text="1" runat="server"></asp:TextBox>
										...
										<!-- end form-group row -->
										<!-- begin page-header -->
											<h1 class="page-header">Reporte contenido no consumido por meses<small></small></h1>
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_CONTENIDO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label544" runat="server" Text='<%# Eval("FECHA") %>'></asp:Label></td>
															</tr>
															</ItemTemplate>
															</asp:Repeater>
														</tbody>
