...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    background-image: linear-gradient(to bottom right, rgba(0, 0, 0, 0.5), /* Adjust transparency for top side */ transparent);">
			...
			<asp:Label ID="lblRedSocial" runat="server" Text="" Visible="false"></asp:Label>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- begin page-header -->
											<h1 class="page-header">Administrador de redes sociales <small></small></h1>
							...
							<table id="data-table-responsive" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
								<thead>
									<tr>
													<th class="text-wrap">RED SOCIAL</th>
								...
								<tbody>
									...
									<ItemTemplate>
										...
										<tr class="gradeA">
													...
													<td><asp:Label ID="lblEsPrincipal" runat="server" Text='<%# Eval("RED_SOCIAL") %>'></asp:Label></td>
													<td><asp:Label ID="Label2" runat="server" Text='<%# Eval("ICONO") %>'></asp:Label></td>
													<td><asp:Label ID="Label1" runat="server" Text='<%# Eval("URL") %>'></asp:Label></td>
													<td><asp:Label ID="Label5" runat="server" Text='<%# Eval("DESC_ESTADO") %>'></asp:Label></td>
											<td>
													<asp:Button ID="btnEditar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("RED_SOCIAL") %>' OnClick="btnEditar_Click" runat="server" Text="Editar" ToolTip="Editar" />
													<asp:Button ID="btnEliminar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("RED_SOCIAL") + "|" + Eval("DESC_ESTADO") %>' OnClick="btnEliminar_Click" runat="server" Text="Activar/Desactivar" ToolTip="Activa o desactiva el registro" />
		 ...
		 <asp:View ID="View2" runat="server">
			...
			<div class="row">
				...
				<div class="col-md-6 offset-md-2">
					...
					<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16">Registro de redes sociales</legend>
					
					<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						<label class="col-md-3 text-md-right col-form-label">Red social:</label>
						<div class="col-md-6">
                             <asp:TextBox ID="txtRedSocial" class="form-control" runat="server"></asp:TextBox>
							<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtRedSocial" Font-Bold="True"></asp:RequiredFieldValidator>
						</div>
					</div>
					<!-- end form-group row -->
				<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						<label class="col-md-3 text-md-right col-form-label">Icono:</label>
						<div class="col-md-6">
                             <asp:TextBox ID="txtIcono" class="form-control" runat="server"></asp:TextBox>
							<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtIcono" Font-Bold="True"></asp:RequiredFieldValidator>
						</div>
					</div>
					<!-- end form-group row -->
					<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						...
						<div class="col-md-6">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtUrl" Font-Bold="True"></asp:RequiredFieldValidator>
						</div>
					</div>
					<!-- end form-group row -->
