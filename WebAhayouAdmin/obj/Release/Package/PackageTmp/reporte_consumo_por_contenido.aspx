<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_consumo_por_contenido.aspx.cs" Inherits="WebAhayouAdmin.reporte_consumo_por_contenido" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- end form-group row -->
										<!-- begin page-header -->
											<h1 class="page-header">Reporte consumo por contenido<small></small></h1>
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_CONTENIDO") %>'></asp:Label></td>
																							...
																							<td><asp:Label ID="Label544" runat="server" Text='<%# Eval("FECHA_CREACION") %>'></asp:Label></td>
																							<td><asp:Label ID="Label545" runat="server" Text='<%# Eval("VISTAS") %>'></asp:Label></td>
															</tr>
															</ItemTemplate>
															</asp:Repeater>
														</tbody>
