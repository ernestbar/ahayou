...
{
    public partial class reporte_registro_contenidos : System.Web.UI.Page
    {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            Repeater1.DataSource = Clases.Reportes.PR_REP_GET_REGISTRO_CONTENIDO(DateTime.Parse(fecha_ini), DateTime.Parse(fecha_fin),txtContenido.Text);
            Repeater1.DataBind();
        }
    }
}