<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_registro_contenidos.aspx.cs" Inherits="WebAhayouAdmin.reporte_registro_contenidos" %>
        ...
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										<div class="form-group row m-b-10">
                                            ...
                                            Nombre contenido:
                                            <asp:TextBox ID="txtContenido" class="form-control" runat="server"></asp:TextBox>
										...
										<!-- end form-group row -->
										<!-- begin page-header -->
											<h1 class="page-header">Reporte registro de contenidos<small></small></h1>
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_CONTENIDO") %>'></asp:Label></td>
																							...
																							<td><asp:Label ID="Label54" runat="server" Text='<%# Eval("CALIFICACION") %>'></asp:Label></td>
																							<td><asp:Label ID="Label541" runat="server" Text='<%# Eval("RESUMEN") %>'></asp:Label></td>
																							<td><asp:Label ID="Label542" runat="server" Text='<%# Eval("GENERO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label543" runat="server" Text='<%# Eval("FECHA_CREACION") %>'></asp:Label></td>
																							<td><asp:Label ID="Label544" runat="server" Text='<%# Eval("VISTAS") %>'></asp:Label></td>
															</tr>
															</ItemTemplate>
															</asp:Repeater>
														</tbody>
