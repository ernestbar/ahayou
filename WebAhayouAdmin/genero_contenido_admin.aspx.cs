...
{
    public partial class genero_contenido_admin : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lblCodigo.Text == "")
                {
                    Clases.Genero_contenidos obj = new Clases.Genero_contenidos("I", 0, Int64.Parse(ddlFormatoContenido.SelectedValue), ddlClasificacion.SelectedValue, lblUsuario.Text);
                    obj.ABM();
                ...
                else
                {
                    ...
                    Clases.Genero_contenidos obj = new Clases.Genero_contenidos("U", Int64.Parse(lblCodigo.Text), Int64.Parse(ddlFormatoContenido.SelectedValue), ddlClasificacion.SelectedValue, lblUsuario.Text);
                    obj.ABM();
                    lblAviso.Text = obj.PV_DESCRIPCIONPR;
                    MultiView1.ActiveViewIndex = 0;
                    Repeater1.DataBind();
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Clases.Genero_contenidos obj_m = new Clases.Genero_contenidos(Int64.Parse(lblCodigo.Text));
                txtCodigo.Text = obj_m.PB_COD_GENERO.ToString();
                txtFormatoContenido.Text = ddlFormatoContenido.SelectedItem.Text;
                ddlClasificacion.DataBind();
                ddlClasificacion.SelectedValue = obj_m.PV_GENERO;
                MultiView1.ActiveViewIndex = 1;
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                id = obj.CommandArgument.ToString();
                lblCodigo.Text = id;
                Clases.Genero_contenidos obj_m = new Clases.Genero_contenidos("D", Int64.Parse(lblCodigo.Text), Int64.Parse(ddlFormatoContenido.SelectedValue), "", lblUsuario.Text);
                obj_m.ABM();
        ...
        protected void ddlFormatoContenido_DataBound(object sender, EventArgs e)
        {
            ddlFormatoContenido.Items.Insert(0, "SELECCIONAR");
        }
    }
}