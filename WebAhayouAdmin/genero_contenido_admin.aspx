<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="genero_contenido_admin.aspx.cs" Inherits="WebAhayouAdmin.genero_contenido_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<asp:ObjectDataSource ID="odsFormatoContenido" runat="server" SelectMethod="PR_STR_GET_FORMATO_CONTENIDO" TypeName="WebAhayouAdmin.Clases.Formatos_contenido">
	</asp:ObjectDataSource>
	   <asp:ObjectDataSource ID="odsGrilla" runat="server" SelectMethod="PR_STR_GET_GENERO_CONTENIDO" TypeName="WebAhayouAdmin.Clases.Genero_contenidos">
		   <SelectParameters>
				<asp:ControlParameter ControlID="ddlFormatoContenido" Name="pB_COD_FORMATO_CONTENIDO" Type="String" />
		</SelectParameters>
	</asp:ObjectDataSource>
	   ...
	   <SelectParameters>
			<asp:Parameter DefaultValue="GENERO" Name="pV_DOMINIO" />
	</SelectParameters>
</asp:ObjectDataSource>
    <!-- begin #content -->
        ...
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
                                                <asp:Button ID="btnNuevo" class="btn btn-success btn-lg col-md-12" BackColor="Transparent" OnClick="btnNuevo_Click" runat="server" Text="Nuevo genero contenido" />
										...
										<!-- begin page-header -->
												<!-- begin page-header -->
																<h1 class="page-header">Genero de contenidos admin <small></small></h1>
																Formato contenido:
											...
											<table id="data-table-responsive" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
												<thead>
													<tr>
													<th class="text-wrap">CODIGO GENERO</th>
									...
									<ItemTemplate>
													...
													<td><asp:Label ID="lblEsPrincipal1" runat="server" Text='<%# Eval("COD_GENERO_CONTENIDO") %>'></asp:Label></td>
													<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("FORMATO_CONTENIDO") %>'></asp:Label></td>
													<td><asp:Label ID="lblEsPrincipal3" runat="server" Text='<%# Eval("GENERO") %>'></asp:Label></td>
																	
																	<%--<td><asp:Label ID="Label5" runat="server" Text='<%# Eval("DESC_ESTADO") %>'></asp:Label></td>--%>
													<td>
																	<asp:Button ID="btnEditar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("COD_GENERO_CONTENIDO") %>' OnClick="btnEditar_Click" runat="server" Text="Editar" ToolTip="Editar" />
																	<asp:Button ID="btnEliminar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("COD_GENERO_CONTENIDO") %>' OnClientClick="return confirm('Estas seguro de eliminar el registro???')" OnClick="btnEliminar_Click" runat="server" Text="Eliminar" ToolTip="Elimina el registro" />
		 ...
		 <asp:View ID="View2" runat="server">
			...
			<div class="row">
				...
				<div class="col-md-6 offset-md-2">
					...
					<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16">Registro de genero contenido</legend>
					
					<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						<label class="col-md-3 text-md-right col-form-label">Codigo genero contenido:</label>
						<div class="col-md-6">
