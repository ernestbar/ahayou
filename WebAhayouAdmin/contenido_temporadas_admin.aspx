<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="contenido_temporadas_admin.aspx.cs" Inherits="WebAhayouAdmin.contenido_temporadas_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<asp:ObjectDataSource ID="odsContenido" runat="server" SelectMethod="PR_STR_GET_FORMATO_CONTENIDO" TypeName="WebAhayouAdmin.Clases.Contenido">
	   ...
	   <asp:ObjectDataSource ID="odsGrilla" runat="server" SelectMethod="PR_STR_GET_CONTENIDO_TEMPORADAS" TypeName="WebAhayouAdmin.Clases.Contenido_temporadas">
		   <SelectParameters>
				<asp:ControlParameter ControlID="ddlContenido" Name="pV_COD_CONTENIDO_STR" Type="String" />
		</SelectParameters>
	</asp:ObjectDataSource>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- begin page-header -->
												<!-- begin page-header -->
																<h1 class="page-header">Contenido temporadas admin <small></small></h1>
																Contenido:
