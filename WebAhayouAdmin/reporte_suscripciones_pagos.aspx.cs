...
{
    public partial class reporte_suscripciones_pagos : System.Web.UI.Page
    {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            Repeater1.DataSource = Clases.Reportes.PR_REP_GET_SUSCRIPCIONES_PAGOS(DateTime.Parse(fecha_ini), DateTime.Parse(fecha_fin), txtContenido.Text,txtEmail.Text);
            Repeater1.DataBind();
        }
    }
}