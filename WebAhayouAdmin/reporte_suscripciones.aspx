<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_suscripciones.aspx.cs" Inherits="WebAhayouAdmin.reporte_suscripciones" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- end form-group row -->
										<!-- begin page-header -->
											<h1 class="page-header">Reporte de suscripciones<small></small></h1>
