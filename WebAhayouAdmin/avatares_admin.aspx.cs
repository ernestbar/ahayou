...
{
    public partial class avatares_admin : System.Web.UI.Page
    {
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lblCodAvatar.Text = datos[0];
                if (datos[1] == "ACTIVO")
                {
                    Clases.Roles obj_m = new Clases.Roles("D", lblCodAvatar.Text, "", lblUsuario.Text);
                    obj_m.ABM();
                    lblAviso.Text = obj_m.PV_DESCRIPCIONPR;
                }
                else
                {
                    Clases.Roles obj_m = new Clases.Roles("A", lblCodAvatar.Text, "", lblUsuario.Text);
                    obj_m.ABM();
                    lblAviso.Text = obj_m.PV_DESCRIPCIONPR;
                }
