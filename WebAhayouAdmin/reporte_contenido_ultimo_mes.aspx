<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_contenido_ultimo_mes.aspx.cs" Inherits="WebAhayouAdmin.reporte_contenido_ultimo_mes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	    ...
	    <asp:ObjectDataSource ID="odsReporte" runat="server" SelectMethod="PR_REP_GET_CONTENIDO_CARGADO_ULTIMO_MES" TypeName="WebAhayouAdmin.Clases.Reportes">
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- end form-group row -->
										<!-- begin page-header -->
											<h1 class="page-header">Reporte contenido cargado el ultimo mes<small></small></h1>
													...
													<table id="data-table-buttons" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
														<thead>
															...
															<th class="text-wrap">NOMBRE CONTENIDO</th>
																			...
																			<th class="text-nowrap">GESTION AUDIO</th>
																			<th class="text-nowrap">CALIFICACION</th>
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_CONTENIDO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label21" runat="server" Text='<%# Eval("PRODUCTORA") %>'></asp:Label></td>
																							<td><asp:Label ID="Label22" runat="server" Text='<%# Eval("FORMATO_CONTENIDO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label23" runat="server" Text='<%# Eval("GESTION_AUDIO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label541" runat="server" Text='<%# Eval("CALIFICACION") %>'></asp:Label></td>
																							<td><asp:Label ID="Label542" runat="server" Text='<%# Eval("RESUMEN") %>'></asp:Label></td>
																							<td><asp:Label ID="Label543" runat="server" Text='<%# Eval("GENERO") %>'></asp:Label></td>
																							<td><asp:Label ID="Label544" runat="server" Text='<%# Eval("FECHA_PUBLICACION") %>'></asp:Label></td>
															</tr>
															</ItemTemplate>
															</asp:Repeater>
														</tbody>
