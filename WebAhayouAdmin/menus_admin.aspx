<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="menus_admin.aspx.cs" Inherits="WebAhayouAdmin.menus_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	   <asp:ObjectDataSource ID="odsMenuPadre" runat="server" SelectMethod="PR_SEG_GET_MENUS_PADRE" TypeName="WebAhayouAdmin.Clases.Menus">
	...
	<SelectParameters>
	   ...
	   <asp:ObjectDataSource ID="odsSistemas" runat="server" SelectMethod="PR_PAR_GET_DOMINIOS" TypeName="WebAhayouAdmin.Clases.Dominios">
	<SelectParameters>
		<asp:Parameter DefaultValue="sistemas" Name="pV_DOMINIO" Type="String" />
	</SelectParameters>
</asp:ObjectDataSource>
        ...
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
                                                <asp:Button ID="btnNuevo" class="btn btn-success btn-lg col-md-12" BackColor="Transparent" OnClick="btnNuevo_Click" runat="server" Text="Nuevo Menu" />
										...
										<!-- begin page-header -->
											<h1 class="page-header">Administrador de menus <small></small></h1>
							...
							<table id="data-table-responsive" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
								<thead>
									<tr>
									<th class="text-wrap">COD MENU</th>
									<th class="text-wrap">COD MENU PADRE</th>
									<th class="text-wrap">NIVEL</th>
								...
								<tbody>
									...
									<ItemTemplate>
													...
													<td><asp:Label ID="lblEsPrincipal1" runat="server" Text='<%# Eval("cod_menu_PADRE") %>'></asp:Label></td>
													<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("level") %>'></asp:Label></td>
													...
													<td>
																	<asp:Button ID="btnEditar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("cod_menu") %>' OnClick="btnEditar_Click" runat="server" Text="Editar" ToolTip="Editar" />
																	<asp:Button ID="btnEliminar" class="btn btn-success btn-sm" BackColor="Transparent" forecolor="Black" CommandArgument='<%# Eval("cod_menu") + "|" + Eval("DESC_ESTADO") %>' OnClick="btnEliminar_Click" runat="server" Text="Activar/Desactivar" ToolTip="Activa o desactiva el registro" />
		 ...
		 <asp:View ID="View2" runat="server">
			...
			<div class="row">
				...
				<div class="col-md-6 offset-md-2">
					...
					<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16">Registro de Menus</legend>
					<!-- begin form-group row -->
					<div class="form-group row m-b-10">
									<label class="col-md-3 text-md-right col-form-label">Es menu padre?</label>
									<div class="col-md-6">
							 <asp:DropDownList ID="ddlMenuPadre" class="form-control col-md-6" DataSourceID="odsMenuPadre" DataTextField="descripcion" DataValueField="cod_menu" OnDataBound="ddlMenuPadre_DataBound" runat="server"></asp:DropDownList>
									</div>
					</div>
					<!-- end form-group row -->
					<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						<label class="col-md-3 text-md-right col-form-label">Desripcion:</label>
						<div class="col-md-6">
                             <asp:TextBox ID="txtDescripcion" class="form-control" runat="server"></asp:TextBox>
							<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtDescripcion" Font-Bold="True"></asp:RequiredFieldValidator>
						</div>
					</div>
					<!-- end form-group row -->
				<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						...
						<div class="col-md-6">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtDetalle" Font-Bold="True"></asp:RequiredFieldValidator>
						</div>
					</div>
					<!-- end form-group row -->
						<!-- begin form-group row -->
				<div class="form-group row m-b-10">
								...
								<div class="col-md-6">
						 <asp:DropDownList ID="ddlSistema" class="form-select" DataSourceID="odsSistemas" DataTextField="descripcion" DataValueField="CODIGO" OnDataBound="ddlSistema_DataBound" runat="server"></asp:DropDownList>
								</div>
				</div>
				<!-- end form-group row -->
				<!-- begin form-group row -->
