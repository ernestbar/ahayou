...
{
    public partial class formato_contenido_admin : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lblCodigo.Text == "")
                {
                    Clases.Formatos_contenido obj = new Clases.Formatos_contenido("I",0,txtFormato.Text, txtFormatoIngles.Text,Int64.Parse(txtOrden.Text), lblUsuario.Text);
                    obj.ABM();
                ...
                else
                {
                    ...
                    Clases.Formatos_contenido obj = new Clases.Formatos_contenido("U", Int64.Parse(lblCodigo.Text), txtFormato.Text, txtFormatoIngles.Text, Int64.Parse(txtOrden.Text), lblUsuario.Text);
                    obj.ABM();
                    lblAviso.Text = obj.PV_DESCRIPCIONPR;
                    MultiView1.ActiveViewIndex = 0;
                    Repeater1.DataBind();
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Clases.Formatos_contenido obj_m = new Clases.Formatos_contenido(Int64.Parse(id));
                txtFormato.Text = obj_m.PV_FORMATO_CONTENIDO;
                txtFormatoIngles.Text = obj_m.PV_FORMATO_CONTENIDO_INGLES;
                txtOrden.Text = obj_m.PB_ORDEN.ToString();
                MultiView1.ActiveViewIndex = 1;
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                id = obj.CommandArgument.ToString();
                lblCodigo.Text = id;
                Clases.Formatos_contenido obj_m = new Clases.Formatos_contenido("U", Int64.Parse(lblCodigo.Text), txtFormato.Text, txtFormatoIngles.Text, Int64.Parse(txtOrden.Text), lblUsuario.Text);
                obj_m.ABM();
