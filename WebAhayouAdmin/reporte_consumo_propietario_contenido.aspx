<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_consumo_propietario_contenido.aspx.cs" Inherits="WebAhayouAdmin.reporte_consumo_propietario_contenido" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										...
										<!-- end form-group row -->
										<!-- begin page-header -->
											<h1 class="page-header">Reporte consumo por propietarios de contenido<small></small></h1>
											<div class="panel-body">
													<table id="data-table-buttons" width="100%" class="table table-striped table-bordered align-middle text-nowrap" style="background-color:white;">
														<thead>
															<tr>
															<th class="text-wrap">NOMBRE PRODUCTOR</th>
														...
														<tbody>
															...
															<ItemTemplate>
																			...
																			<td><asp:Label ID="lblEsPrincipal2" runat="server" Text='<%# Eval("NOMBRE_PRODUCTOR") %>'></asp:Label></td>
