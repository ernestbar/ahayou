<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="contenido_peliculas_admin.aspx.cs" Inherits="WebAhayouAdmin.contenido_peliculas_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	   ...
	   <asp:ObjectDataSource ID="odsGrilla" runat="server" SelectMethod="PR_STR_GET_CONTENIDO_PELICULA" TypeName="WebAhayouAdmin.Clases.Contenido_peliculas">
		   <SelectParameters>
        ...
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
                                                <asp:Button ID="btnNuevo" class="btn btn-success btn-lg col-md-12" BackColor="Transparent" OnClick="btnNuevo_Click" runat="server" Text="Nuevo contenido pelicula" />
										...
										<!-- begin page-header -->
												<!-- begin page-header -->
																<h1 class="page-header">Contenido peliculas admin <asp:Label ID="lblTitulo" runat="server" Text=""></asp:Label> <small> </small></h1>
																<%--Contenido:
...
<div class="row">
	...
	<div class="col-md-12 offset-md-0">
		...
		<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16">Registro de contenido peliculas</legend>
		<!-- BEGIN #accordion -->
				...
				<div class="accordion-item border-0">
					<div class="accordion-header" id="headingOne">
						<button class="accordion-button bg-gray-900 text-white px-3 py-10px pointer-cursor" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
							<i class="fa fa-circle fa-fw text-blue me-2 fs-8px"></i> DATOS PELICULA
						</button>
					</div>
