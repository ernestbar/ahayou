<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reset_password_us.aspx.cs" Inherits="landingAhayou.reset_password_us" %>
    ...
    <form id="form1" runat="server">
         ...
         <header class="header">
                    ...
                    <div class="header__nav-buttons header__nav-buttons--with-text">
                        ...
                        <asp:Button class="header__button header__button--text header__button--bg-orange" ID="btnSuscribete" OnClick="btnSuscribete_Click" runat="server" Text="Suscribe" />
                        <asp:Button class="header__button header__button--text header__button--bg-green" ID="btnLogin" OnClick="btnLogin_Click" runat="server" Text="Login" />
            ...
            >
                <div class="container__wrapper">
                    ...
                    <div class="container--flex container--flex-column container--gap-medium text text--light">
                        <p>Hi, <asp:Label ID="lblEmail" runat="server" Text=""></asp:Label></p>
                        <p>
                            Let's reset your password, review recent account logins for unusual activity.
                        </p>
                        <p>
                    ...
                    <asp:Button class="button button--orange full-width button--border" OnClick="btnReset_Click" ID="btnReset" runat="server" Text="Reset password" />
                </div>
            </section>
        </main>
        <footer class="footer">
