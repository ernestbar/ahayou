          ...
          <header class="header">
            ...
            <p class="text text--center text--light">
                ...
                <form class="form container--shiny container--padding-width" id="form">
                    ...
                    <asp:LinkButton ID="lbtnSolicitarPIN" Font-Size="X-Large" OnClick="lbtnSolicitarPIN_Click" runat="server">Press and we will send a new PIN to your email.</asp:LinkButton>
                    <div class="form__input-container">
                        <label
                            for="password"
                            class="form__label form__label--second"
                    ...
                    <div class="form__input-container">
                        <label
                            ...
                            class="form__label form__label--second"
                        >
                            Active devices with your account
                        </label>
                           <table style="" border="1" cellpadding="0">
                               <thead>
                                   <tr>
                                       <th class="text-wrap">Device</th>
                                       <th class="text-nowrap">Date</th>
                                       <th class="text-nowrap" data-orderable="false">OPTION</th>
                                       </tr>
                                   </thead>
                               <tbody>
                ...
                <asp:LinkButton ID="lbtnEliminarSuscriptor" OnClick="lbtnEliminarSuscriptor_Click" ForeColor="Orange" OnClientClick="return confirm('Are you sure you want to delete your user? If you do, you will no longer be able to enjoy Ahayou content.')" runat="server"><p class="text text--red">Delete my account</p></asp:LinkButton>
                </form>
