<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cartelera_us.aspx.cs" Inherits="landingAhayou.cartelera_us" %>
            ...
            <nav class="header__nav">
                <a href="cartelera.aspx" class="header__logo">
                    ...
                    <div class="header__nav-buttons header__nav-input">
                            <asp:TextBox ID="txtBusqueda" class="header__input" ValidationGroup="busqueda" placeholder="Search..." runat="server"></asp:TextBox>
                 ...
                 <div class="options__container">
                     ...
                     <div class="options__menu" id="optionsMenu">
                         ...
                         <button class="options__button" >Ingl&eacute;s</button>--%>
                            ...
                            <input class="options__button" type="button" onclick="location.href='login_us.aspx';" value="Login" />                     </div>
                 </div>
                                            ...
                                            >
                                             ...
                                             />
                                                <div class="movie__buttons">
                                                    ...
                                                    <a
                                                        href=' <%# "mas_informacion_us.aspx?ID=" + Eval("cod_contenido_str") %>'
                       ...
                       <ItemTemplate>
                        <asp:Label ID="lblSeccion" runat="server" Text=' <%# Eval("descripcion") %>' Visible="false"></asp:Label>
                           <asp:Panel class="playlist__content container--flex container--flex-column container--flex-wrap full-width" ID="Panel_normal" runat="server">
                                ...
                                >
                                    <span class="text--bold"><%# Eval("descripcion_ingles") %></span>
                                </h2>
