<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cambio_password_us.aspx.cs" Inherits="landingAhayou.cambio_password_us" %>
                    ...
                    <form class="form" id="form">
                        ...
                        <div class="form__input-container">
                         ...
                         <div class="form__input-container">
                             ...
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="password"  ControlToValidate="txtPassAnt" runat="server" ErrorMessage="* required" ForeColor="Orange"></asp:RequiredFieldValidator>
                            </div>
                        <div class="form__input-container">
                            <asp:TextBox ID="txtPassword" TextMode="Password" placeholder="New password (6-60 character)" class="form__input container--border-gray" runat="server"></asp:TextBox>
                        </div>
                        <div class="form__input-container">
                            <asp:TextBox ID="txtPassword2" TextMode="Password"  placeholder="New password (6-60 character)" class="form__input container--border-gray" runat="server"></asp:TextBox>
                        </div>
                        <asp:CompareValidator ID="cfvNumeroCelular" runat="server"  ControlToCompare="txtPassword" ValidationGroup="password" ControlToValidate="txtPassword2" Operator="Equal" Type="Integer" Display="Dynamic" ErrorMessage="* The new passwords do not match." ></asp:CompareValidator>
                        ...
                        >
                            <asp:Button ID="btnGuardar" class="button button--orange full-width button--border" ValidationGroup="password" OnClick="btnGuardar_Click" runat="server" Text="Save" />
                            <asp:Button ID="btnCancelar" class="button button--green full-width button--border" OnClick="btnCancelar_Click" runat="server" Text="Cancel" />
                        </div>
                    </form>
                </div>
            </section>
