<%@ Page Language="C#" EnableEventValidation="false"  AutoEventWireup="true" CodeBehind="suscribete_us.aspx.cs" Inherits="landingAhayou.suscribete_us" %>
          ...
          <asp:ObjectDataSource ID="odsRedesSociales" runat="server" SelectMethod="PR_PAR_GET_REDES_SOCIALES_STR" TypeName="landingAhayou.Clases.Contenidos">
            ...
            >
                ...
                <p class="text text--center text--light">
                    AHAYOU is personalized for you.
                </p>
                <p class="text text--center text--light">
                    Create a password to start watching AHAYOU
                </p>
                    ...
                    <form class="form container--shiny container--padding-width" id="form">
                        <div class="form__input-container">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="formulario" ControlToValidate="email" runat="server" ErrorMessage="* required" ForeColor="Orange"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form__input-container">
                            <label
                                for="email"
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="formulario" ControlToValidate="celular" runat="server" ErrorMessage="* required" ForeColor="Orange"></asp:RequiredFieldValidator>
                            <asp:RangeValidator runat="server" ID = "valRangeTxtcontactId" ValidationGroup="formulario"  controlToValidate="celular" Type ="Integer" Minimumvalue = "0" Maximumvalue ="2147483647" ForeColor="Orange" ErrorMessage="Only numbers" Display="Dynamic"></asp:RangeValidator>
                        </div>
                        <div class="form__input-container">
                            <label
                                for="email"
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="formulario" ControlToValidate="nombre" runat="server" ErrorMessage="* required" ForeColor="Orange"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form__input-container">
                            <label
                                for="email"
                        ...
                        <div class="form__input-container">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="formulario" ControlToValidate="Password" runat="server" ErrorMessage="* required" ForeColor="Orange"></asp:RequiredFieldValidator>
                        </div>
                        <asp:Button class="button button--orange full-width button--border " ValidationGroup="formulario" OnClick="btnSiguiente_Click" ID="btnSiguiente" runat="server" Text="Next" />
