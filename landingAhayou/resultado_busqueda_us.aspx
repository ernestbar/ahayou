<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resultado_busqueda_us.aspx.cs" Inherits="landingAhayou.resultado_busqueda_us" %>
          ...
          <header class="header">
            <nav class="header__nav">
              ...
              <main class="main">
                ...
                >
        <h1>Search results: <asp:Label ID="lblMenu" runat="server" Visible="true" Text=""></asp:Label></h1>
